    ...
    <ul class="navbar-nav ml-auto">
        ...
        <div id="dropdownHoverButton" data-dropdown-toggle="dropdownHover" data-dropdown-trigger="hover"
            ...
            <div class="info m-auto">
                <a href="#" class="d-block text-bold text-pal-1">Mr. Edgar Delmo</a>
                <span class="d-block text-regular text-pal-1" style="font-size: .8rem;">Director</span>
            </div>
        </div>
        ...
        <div id="dropdownHover" class="z-10 hidden pal-1 divide-y divide-gray-100 rounded-lg shadow w-44">
            <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownHoverButton">
                <a href="{{ route('director.my_profile') }}" class="block px-4 py-2 text-white">Profile</a>
                </li>
                <li>
                    <a id="show-modal-logout" class="block px-4 py-2 text-white director-logout-button"><button>Log out</button></a>
                </li>
            </ul>
        </div>
    </ul>
