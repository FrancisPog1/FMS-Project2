...
$(document).ready(function() {
    var filteredAssigneesUrl = "{{ route('filtered_assignees', ':bin_id') }}";
    ...
    $("#filter").on('change', function() {
        ...
        $.ajax({
            url: filteredAssigneesUrl.replace(':bin_id', binId),
            type: "GET",
            headers: {
...
<script>
    $(document).ready(function() {
        var filteredAssigneesUrl = "{{ route('sorted_assignees', ':bin_id') }}";
        var binId = "{{$bin_id}}"; // Assuming you have the bin_id value available in the template
