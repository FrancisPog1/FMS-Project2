 ...
 $(document).ready(function() {
    var filteredAndSortedAssigneesUrl = "{{ route('admin.filtered_and_sorted_assignees', ':bin_id') }}";
    ...
    $("#filter, #sort").on('change', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var html = '';
                var monitorRoute = "{{ route('admin.monitor_requirements.show', ['user_id' => ':user_id', 'assigned_bin_id' => ':assigned_req_id', 'req_bin_id' => ':req_bin_id']) }}";
