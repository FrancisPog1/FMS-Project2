...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <!-- Title with PUP logo -->
        <link rel="icon" href="dist/img/pup.png" />
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <div id="dropdownHoverButton" data-dropdown-toggle="dropdownHover" data-dropdown-trigger="hover" class="user-panel d-flex">
                        ...
                        <div class="info m-auto">
                            <a href="#" class="d-block text-col-1 text-bold">Demelyn Monzon</a>
                    ...
                    <div id="dropdownHover" class="z-10 hidden pal-1 divide-y divide-gray-100 rounded-lg shadow w-44">
                        ...
                        <li>
                            <a id="show-modal-logout" class="block px-4 py-2 text-white">Log out</a>
                        </li>
                        </ul>
                    </div>
                </ul>
