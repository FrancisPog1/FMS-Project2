                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button"
                                                ...
                                                class="px-3 py-2 text-sm font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 ">Validate</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
