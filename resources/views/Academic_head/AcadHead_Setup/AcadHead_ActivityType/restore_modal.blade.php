    ...
    <section class="content">
        <form action="{{ route('admin.restore_activitytype') }}" method="post">
            @csrf
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <div class="card-body p-0">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                @foreach ($deleted_types as $deleted_type)
                                                    <tr>
                                                        <td>
                                                            <div class="ml-3">
                                                                <input type="checkbox" class="form-check-input"
                                                                    id="checkbox-0_0" name="deleted_reqs[]"
                                                                    value="{{ $deleted_type->id }}">

                                                                <label class="form-check-label"
                                                                    for="checkbox-0_0">{{ $deleted_type->title }}</label>
                                                            </div>

                                                        </td>
                                                        <td>{{ $deleted_type->file_format }}</td>
                                                        ...
                                                        <td>
                                                            <button type="button"
                                                                ...
                                                                name="{{ $deleted_type->id }}"
                                                                data-name="{{ $deleted_type->id }}">
