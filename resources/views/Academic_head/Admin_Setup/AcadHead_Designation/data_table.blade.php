        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <table class="table table-striped">
                    ...
                    <tbody id="filtered-designations">
                                ...
                                <td class="text-center">
                                    <form method="POST" action="{{ route('admin.delete_designations', $designation->id) }}">
                                        ...
                                        <button data-toggle="modal"
                                            onclick="openViewModal('{{ $designation->title }}', '{{ $designation->description }}')"
                                            data-target="#modal-xl-view" type="button"
                                            class="px-2 py-2 text-sm text-center rounded-lg text-blue focus:ring-4 focus:outline-none focus:ring-blue-300">
                                            <i class="far fa-eye"></i>
                                        </button>
                                        <button type="button"
                                            onclick="openEditModal('{{ $designation->title }}', '{{ $designation->description }}',  '{{ $designation->id }}')"
