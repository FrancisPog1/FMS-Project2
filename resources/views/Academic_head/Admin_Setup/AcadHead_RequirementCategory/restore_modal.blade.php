    ...
    <section class="content">
        <form action="{{ route('admin.restore_category') }}" method="post">
            @csrf
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="ml-3">
                                                                ...
                                                                <label class="form-check-label"
                                                                    for="checkbox-0_0">{{ $deleted_category->title }}</label>
                                                            </div>

                                                        </td>
                                                        <td>{{ $deleted_category->description }}</td>
                                                        ...
                                                        <td>
                                                            <button type="button"
                                                                ...
                                                                name="{{ $deleted_category->id }}"
                                                                data-name="{{ $deleted_category->id }}">
