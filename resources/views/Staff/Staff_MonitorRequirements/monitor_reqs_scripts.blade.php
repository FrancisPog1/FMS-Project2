...
$(document).ready(function() {
    ...
    document.addEventListener('click', function(event) {
        if (event.target.matches('#reject-button')) {
            ...
            var rejectRoute = "{{ route('staff.reject_requirements', ['requirementId' => ':requirementId', 'req_bin_id' => ':req_bin_id', 'assigned_bin_id' => ':assignId']) }}";
            ...
            var approveRoute = "{{ route('staff.approve_requirements', ['requirementId' => ':requirementId', 'req_bin_id' => ':req_bin_id', 'assigned_bin_id' => ':assignId']) }}";
