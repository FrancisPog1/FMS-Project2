...
@section('content')
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            {{-- BIN DETAILS --}}
            @include('Staff/Staff_RequirementAssignees/bin_details')

            {{-- DATA TABLE --}}
            @include('Staff/Staff_RequirementAssignees/data_table')
        ...
        <footer class="main-footer">
            ...
            {{-- SCRIPTS --}}
            @include('Staff/Staff_RequirementAssignees/assignees_scripts')
@endsection
