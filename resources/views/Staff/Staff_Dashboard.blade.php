                    ...
                    <div class="container-fluid">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Total Class Attendance</span>
                ...
                <div class="col-sm-6">
                    <div class="container-fluid">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Total Class Schedule</span>
                                <span class="info-box-number">
                                    0
                                </span>
                            </div>
        ...
        <div class="col-md-12 m-auto">
            <div class="row">
                <div class="col-sm-6">
                    <div class="card" style="display: inline-block; width: 100%; border-top: 2px solid #800000;">
                        <div class="card-header">
                            <label>Class Attendance Status Count</label>
                        </div>
                        <div>
                ...
                <div class="col-sm-6">
                    <div class="card" style="display: inline-block; width: 100%; border-top: 2px solid #800000;">
                        <div class="card-header">
                            <label>Class Schedule Status Count</label>
                        </div>
                        <div>
                            <canvas id="" width="324" height="269"
                                style="display: block; box-sizing: border-box; height: 300px; width: 360px;"></canvas>
