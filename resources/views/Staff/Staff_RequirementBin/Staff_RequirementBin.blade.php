...
@section('content')
    <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header ">
            ...
            {{-- DATA TABLE --}}
            @include('Staff/Staff_RequirementBin/data_table')


            {{-- CREATE MODAL --}}
            @include('Staff/Staff_RequirementBin/create_modal')

            {{-- RESTORE MODAL --}}
            @include('Staff/Staff_RequirementBin/restore_modal')
    ...
    {{-- SCRIPTS --}}
    @include('Staff/Staff_RequirementBin/requirementbin_scripts')
@endsection
