    ...
    <form action=" {{ route('admin.update_my_profile', $profile_id) }}" method="post">
    @method('PUT')
    @csrf

            <div id="edit-card" class="card card-transition">
                <div class="card-body mr-4 ml-4" id="cardBody">
                    ...
                    <div class="form-group text-right">
                        <button type="submit" class="mt-2 px-4 py-2 text-sm font-medium text-center text-white pal-1 rounded-lg focus:ring-4 focus:outline-none focus:ring-red-300">Submit</button>
                    </div>
                </div>
            </div>
    </form>
