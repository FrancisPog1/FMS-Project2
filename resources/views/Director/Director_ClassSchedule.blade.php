                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="Dae"
                                                            name="Dae" placeholder="Date" tabindex="1" required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-6 additional-input">
                                                        ...
                                                        <input type="datetime-local" class="form-control"
                                                            id="start_datetime" name="start_datetime" tabindex="1"
                                                            value="" min="" data-parsley-excluded="true">
                                                    </div>
                                                    <div class="form-group col-md-6 additional-input">
                                                        <label class="required-input">End time</label>
                                                        <input type="datetime-local" class="form-control"
                                                            id="end_datetime" name="end_datetime" tabindex="1"
                                                            value="" min="" data-parsley-excluded="true">
                                                    </div>
                                                </div>
                                                <div class="row">
