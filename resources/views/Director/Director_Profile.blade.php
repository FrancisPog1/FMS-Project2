                        ...
                        <div class="card-body box-profile col-md-3">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                    src="https://lh3.googleusercontent.com/a/default-user=s75-c" alt="User profile picture">
                            </div>
                            <h3 class="profile-username text-center">Mr. Edgardo S. Delmo</h3>
                            <p class="text-muted text-center">University Director</p>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="row mx-auto">
                                                <div class="col-md-6">
                                                    ...
                                                    <input id="selectedOption" readonly type="text"
                                                        class="form-control dropdown-toggle" data-toggle="dropdown"
                                                        aria-haspopup="true" aria-expanded="false" placeholder="Regular">
                                                    <div class="dropdown-menu" id="myDropdown">
                                                        <button class="dropdown-item d1" type="button">Faculty
                                                            extensionist</button>
                                                        <button class="dropdown-item d1" type="button">Part-time
                                                            faculty</button>
                                                        <button class="dropdown-item d1" type="button">Regular
                                                            faculty</button>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="required-input">Academic Rank</label>
                                                    <input readonly type="text" class="form-control dropdown-toggle"
                                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                        placeholder="Assoc. Prof.">
                                                    <div class="dropdown-menu" id="myDropdown">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input readonly type="text" class="form-control dropdown-toggle"
                                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                        placeholder="Head, Academic Programs">
                                                    <div class="dropdown-menu" id="myDropdown">
                                                        <button class="dropdown-item" type="button">Option 1</button>
                                                        <button class="dropdown-item" type="button">Administrative
                                                            Personnel</button>
                                                        <button class="dropdown-item" type="button">Faculty
                                                            Management</button>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="dropdown-menu" id="myDropdown">
                                                        <button class="dropdown-item" type="button">Option 1</button>
                                                        <button class="dropdown-item" type="button">Option 2</button>
                                                        <button class="dropdown-item" type="button">Human Resource
                                                            Management</button>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="tab-content">
                                    <div>
                                        <div class="row">
                                            <label class="ml-3 mt-3 mb-3" style="font-size: 1.1rem;">Personal
                                                Information</label>
                                        </div>
                                        <div class="row">
                                            <div class="row mx-auto">
                                        ...
                                        <div class="row">
                                            <div class="row mx-auto">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="date" class="form-control date-range-filter"
                                                        id="date_" name="date_" placeholder="date" tabindex="1"
                                                        required>
                                                </div>
                                                <div class="col-md-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="tab-content">
                                    <div>
                                        <div class="row">
                                            <label class="ml-3 mt-3 mb-3" style="font-size: 1.1rem;">Vicinity
                                                Information</label>
                                        </div>
                                        <div class="row">
                                            <div class="row mx-auto">
                                            ...
                                            <div class="row mx-auto">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input readonly type="text" class="form-control dropdown-toggle"
                                                        aria-haspopup="true" aria-expanded="false" placeholder=" 0988">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
