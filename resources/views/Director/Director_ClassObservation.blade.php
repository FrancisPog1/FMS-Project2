            ...
            <div class="container-fluid">
                <div class="row-col-sm-6 mb-2">
                    <div class="col-md-6 ml-4">
                        <h1 class="m-0">Class Observations</h1>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button"
                                            class="text-white bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-2 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-600 dark:focus:ring-red-800">Cancelled</button>
                                    </td>
                                    <td></td>
                                ...
                                <div class="col-md-12">
                                    <div class="card card-primary">
                                        <div class="container col-sm-5"
                                            style=" padding: 80px; box-shadow: 0px 0px 20px rgba(0, 0, 0, 0.1);">
