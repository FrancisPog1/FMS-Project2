...
class Staff_Activities_Controller extends Controller
{
    public function show(){
        ...
        return view('Staff/Staff_Activities/Staff_Activities', compact('activities', 'activitytypes', 'deleted_activities'));
